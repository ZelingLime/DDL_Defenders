...
{
public:
    static WaveManager* create(Player* player, cocos2d::Layer* parentLayer);
    bool init(Player* player, cocos2d::Layer* parentLayer);
...
private:
    ...
    Player* _player;
    cocos2d::Layer* _parentLayer;   // 用于添加敌人到场景中
